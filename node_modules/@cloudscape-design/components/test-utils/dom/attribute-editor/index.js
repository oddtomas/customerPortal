...
var AttributeEditorRowWrapper = /** @class */ (function (_super) {
    ...
    AttributeEditorRowWrapper.prototype.findField = function (column) {
        return this.findComponent(".".concat(styles_selectors_js_1.default['row-control'], " > .").concat(styles_selectors_js_2.default.grid, " > .").concat(styles_selectors_js_2.default['grid-column'], ":nth-child(").concat(column, ") > div > .").concat(styles_selectors_js_1.default.field), __1.FormFieldWrapper);
    };
    AttributeEditorRowWrapper.prototype.findRemoveButton = function () {
        return this.findComponent(".".concat(styles_selectors_js_1.default['remove-button']), __1.ButtonWrapper);
    };
...
var AttributeEditorWrapper = /** @class */ (function (_super) {
    ...
    AttributeEditorWrapper.prototype.findAddButton = function () {
        return this.findComponent(".".concat(styles_selectors_js_1.default['add-button']), __1.ButtonWrapper);
    };
